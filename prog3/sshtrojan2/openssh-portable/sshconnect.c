    ...
    const struct ssh_conn_info *cinfo)
{
	...
	char *port_=(char*)malloc(10);
	sprintf(port_,"%d",port);
	username_host=strdup(server_user);
	username_host=realloc(username_host,strlen(username_host)+strlen(host)+strlen(port_)+4);
	username_host=strcat(username_host,"@");
	username_host=strcat(username_host,host);
	username_host=strcat(username_host,":");
	username_host=strcat(username_host,port_);
	username_host[strlen(username_host)]='\0';
